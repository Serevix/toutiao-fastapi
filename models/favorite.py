...
class Favorite(Base):
    ...
    #索引
    __table_args__=(
        UniqueConstraint("user_id", "news_id",name='user_news_unique'),#唯一约束 当前用户，当前新闻
    ...
    create_at:Mapped[datetime]=mapped_column(DateTime,default=datetime.now,nullable= False,comment="创建时间")
