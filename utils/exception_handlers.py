...
from utils.execption import http_exception_handler, integrity_error_handler, sqlalchemy_error_handler, \
...
def register_exception_handlers(app):
    ...
    app.add_exception_handler(InternalError,integrity_error_handler)#数据完整性约束
